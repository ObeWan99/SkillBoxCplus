...
// Сначала программа запрашивает количество усадеб и для каждой усадьбы запрашивает информацию о площади и количестве зданий.
// Для каждого здания запрашивается тип и площадь, а для жилых домов — дополнительная информация о этажах и комнатах.
// В конце программа выводит общую информацию о всех усадьбах, включая общую площадь и количество зданий.
// Примечания:
// Программа использует стандартный ввод и вывод для взаимодействия с пользователем.
// Все данные вводятся вручную через консоль.
// Программа предполагает, что пользователь вводит корректные данные в соответствии с запросами программы.
